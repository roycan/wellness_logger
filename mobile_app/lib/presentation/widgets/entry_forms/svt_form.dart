...
/// Form widget for creating SVT Episode entries
class SvtForm extends StatefulWidget {
  final SvtEpisode? initialEntry;
  
  const SvtForm({super.key, this.initialEntry});

  @override
  State<SvtForm> createState() => _SvtFormState();
}

class _SvtFormState extends State<SvtForm> {
  ...
  void initState() {
    ...
    if (widget.initialEntry != null) {
      ...
      _durationController.text = '1 minute';
    }
  }

  void _populateForm(SvtEpisode entry) {
  ...
  String? _validateDuration(String? value) {
    if (value == null || value.trim().isEmpty) {
      return 'Please enter episode duration';
    }
    
    // Use the same regex from SvtEpisode validation
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(widget.initialEntry != null ? 'SVT episode updated!' : 'SVT episode saved!'),
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: 'Triggers, symptoms, notes...',
                border: OutlineInputBorder(),
              ),
              maxLines: 3,
            ),
            ...
            ElevatedButton(
              ...
              child: _isLoading
                  ...
                  : Text(widget.initialEntry != null ? 'Update Episode' : 'Save Episode'),
            ),
          ],
        ),
      ),
